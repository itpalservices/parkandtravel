...
- **Configuration Settings**: Admin users can manage parking availability, base prices, progressive price increments, car wash service options, delivery fee (car delivery from/to airport), and email description text.
